...
var PRECACHE_URLS = [
  ...
  '/assets/images/logo/better-agoo-logo.svg',
  '/assets/images/logo/better-agoo-logo-white.svg',
...
self.addEventListener('push', function (event) {
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'BetterAgoo', {
      body: data.body || '',
      icon: '/assets/images/logo/favicon.svg',
      badge: '/assets/images/logo/favicon.svg',
      tag: data.tag || 'betteragoo-notification',
      data: { url: data.url || '/' },
    })
  );
});
