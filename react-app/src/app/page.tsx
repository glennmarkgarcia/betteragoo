...
export default function HomePage() {
  ...
  return (
    <>
          ...
          <div className="appointment-cta-inner">
            ...
            <div className="appointment-cta-content">
              ...
              <div className="appointment-cta-actions">
                <a
                  href="https://agoomayorsoffice-oasys.com/user/auth/login.php"
                ...
                <a
                  href="https://agoomayorsoffice-oasys.com/user/auth/register.php"
            ...
            <div className="map-column">
              <div className="map-card">
                <div
                  id="map-container"
                  role="application"
                  aria-label="Interactive map of Agoo, La Union"
          ...
          <div className="home-contact-v2-grid">
            ...
            <div className="home-contact-v2-card">
              ...
              <div className="home-contact-v2-content">
                ...
                <span className="home-contact-v2-note">Agoo, La Union 2504</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Agoo Quiz CTA */}
      <section className="quiz-cta-section" aria-label="Agoo Quiz">
        <div className="container">
          <div className="quiz-cta-inner">
            ...
            <div className="quiz-cta-content">
              ...
              <a
                href="https://quiz.betteragoo.org/"
